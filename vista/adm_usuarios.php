...
<!--===============================================================================================-->
						...
						while ($filas = mysqli_fetch_assoc($resultado)) {
							...
							echo "</td>";
							echo "<td>";
                            echo "<td> <a href='udgrade_usuario.php?id=" . $filas['id'] . "''><button type='button' class='btn btn-warning'>Administrador</button></a> </td>";
                            echo "<td> <a href='downgrade_usuario.php?id=" . $filas['id'] . "''><button type='button' class='btn btn-danger'>Miembro</button></a> </td>";
							echo "</tr>";
						}?>


            <a href="cantidad.php" class="btn btn-primary btn-lg">Cantidad de proyectos</font></a><br>
					</table>
				</div>
			</form>
		</div>
