	...
	<div class="container-contact100" style="background-image: url('img/blanco.png');">
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form">
              ...
              <th>ESTADO</th>
						<th><th><a href="nuevo_proy.php"> <button type="button" class="btn btn-info">Nuevo Proyecto</button> </a> </th>
						</thead>
              ...
              echo "<td>";
							...
							echo $filas['estado'];
							echo "</td>";
                            echo "<th> </th> <td> <a href='eliminar_proy.php?id_titulo=" . $filas['id_titulo'] . "''><button type='button' class='btn btn-danger'>Eliminar</button></a> </td>";
							echo "</tr>";
                        }
						?>
						<!--===============================================================================================-->
