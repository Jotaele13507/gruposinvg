...
error_reporting(E_ALL ^ E_NOTICE);
	...
	if (isset($_POST['reg_miembro'])) {
		...
		$id_grupo = mysqli_real_escape_string($db, $_POST['id_grupo']);
		$id_usuario = $_SESSION["usuario"]['id'];

			$query = "INSERT INTO miembroginv (id_usuario,cedula_int,nombre_int,apellido_int,estatus_int,grado_int,inst_int,area_int,tel_int,mail_int, id_grupo)
					  VALUES('$id_usuario','$cedula_int','$nombre_int','$apellido_int','$estatus_int','$grado_int','$inst_int','$area_int','$tel_int','$mail_int', '$id_grupo')";
