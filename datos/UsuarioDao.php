...
class UsuarioDao extends Conexion
{
    ...
    {
        $query = "SELECT id,nombre,cedula,email,usuario,privilegio,fecha_registro FROM usuarios WHERE usuario = :usuario AND password = :password";
    ...
    {
        $query = "INSERT INTO usuarios (nombre,email,usuario,cedula,password,privilegio) VALUES (:nombre,:email,:usuario,:cedula,:password,:privilegio)";
